(() => {
    ...
    async function renderHive(id) {
        ...
        const nextActivity = openActivities.filter(item => item.due_date).sort((a,b)=>String(a.due_date).localeCompare(String(b.due_date)))[0] || null;
