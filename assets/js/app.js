(() => {
    ...
    async function renderTechnical(params) {
        ...
        shell({title:'Manejo',subtitle:focusedHive?`Consulta rápida · ${focusedHive.name}`:'Seguimiento de las colmenas por temporada',active:'hives',actions:`${back}${filter}${actions}`,content:`${technicalTabs(view,hiveId,seasonFilter)}${focusBanner}${page}`});hydrateProtectedImages();
    }
